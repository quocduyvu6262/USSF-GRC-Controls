...
# Sprockets need to look into the pagy javascripts dir, so add it to the assetssss paths
# Rails.application.config.assetssss.paths << Pagy.root.join('javascripts')
